...
$image->as(\GdImage::class); // \GdImage
$image->as(\Imagick::class); // \Imagick
$image->as(Intervention\Image\Image::class); // Intervention\Image\Image
$image->as(Imagine\Image\ImageInterface::class); // Imagine\Image\ImageInterface
$image->as(Spatie\Image\Image::class); // Spatie\Image\Image
$image->as(Alto\Image\Image::class); // Alto\Image\Image
```
